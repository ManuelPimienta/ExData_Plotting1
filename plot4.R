...
# ------------------ Dibujo de los datos
# Multiples plots
par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), cex = 0.55)
with(myData, {
  plot(myData$Global_active_power ~ myData$DateTime, type = "l", xlab = "", ylab = "Global Active Power")
  plot(myData$Voltage ~ myData$DateTime, type = "l", xlab = "Date and Time", ylab = "Voltage")
